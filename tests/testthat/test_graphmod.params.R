...
res.miss1<-run.lean.fromdata(g=g_red,gene.list.scores=test.missing,keep.nodes.without.scores=F,n_reps=2)
res.miss2<-run.lean.fromdata(g=g_red,gene.list.scores=test.missing,keep.nodes.without.scores=T,n_reps=2)
...
res.add1<-run.lean.fromdata(g=g_red,gene.list.scores=test.added,add.scored.genes=F,n_reps=2)
res.add2<-run.lean.fromdata(g=g_red,gene.list.scores=test.added,add.scored.genes=T,n_reps=2)
...
res.both1<-run.lean.fromdata(g=g_red,gene.list.scores=test.both,keep.nodes.without.scores=F,add.scored.genes=F,n_reps=2)
res.both2<-run.lean.fromdata(g=g_red,gene.list.scores=test.both,keep.nodes.without.scores=T,add.scored.genes=F,n_reps=2)
res.both3<-run.lean.fromdata(g=g_red,gene.list.scores=test.both,keep.nodes.without.scores=F,add.scored.genes=T,n_reps=2)
res.both4<-run.lean.fromdata(g=g_red,gene.list.scores=test.both,keep.nodes.without.scores=T,add.scored.genes=T,n_reps=2)
